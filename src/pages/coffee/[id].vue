<template>
  <div>
    ...
    <Flicking v-if="preferences.is_mobile && selected_coffee?.aws_pics" class="flicking-container h-max-1/2 h-100" :options="flickingOptions">
      <div
    ...
    <div class="flex flex-col gap-6 container">
      <RouterLink to="/" class="fixed top-25 z-10 ml-10 w-fit rounded-xl bg-cafe-100 px-2 py-1 shadow-2xl transition-all hover:scale-105">
        Retour a la map.
      </RouterLink>
      ...
      <div id="main" class="flex flex-col gap-6 md:flex-row md:justify-between">
        ...
        <div id="righty" class="w-100% flex flex-col place-content-center place-items-center rounded-3xl bg-cafe-200 p-6 text-cafe-600 text-2xl md:w-1/2">
