<template>
  <header class="h-45px w-full flex flex-row items-center justify-between bg-cafe-500">
    ...
    <div ref="menu_button" class="relative">
      <button
        class="focus:outline-none"
        aria-haspopup="true"
        :aria-expanded="display_menu"
        @click="toggleMenu"
      >
        ...
        <div class="py-1" role="none">
          <div v-if="!user.is_auth">
            <button
              ...
              role="menuitem"
              tabindex="-1"
              @click="display.login_modal = !display.login_modal"
            >
              Login
            </button>
          </div>
...
const menu_button = ref(null)
const menu = ref(null)

onClickOutside([menu_button, menu], () => display_menu.value = false)
