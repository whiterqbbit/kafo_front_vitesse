  ...
  <div class="avatar-container flex">
    ...
    >
      ...
      <Teleport v-if="is_mounted" to="#main_container">
        <HoverProfile v-if="hover_profile_visible" :profile_dimensions="profile_dimensions" :attendee="current_attendee ? current_attendee : null" :x="x" :y="y" :width="width" :height="height" class="z-100" />
      </Teleport>
    </div>
  </div>
</template>
